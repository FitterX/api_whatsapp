...
export declare class SenderLayer extends ListenerLayer {
     ...
     */
    sendLinkPreview(chatId: string, url: string, title: string): Promise<unknown>;
    /**
     ...
     * @param caption
     */
    sendImage(to: string, path: string, filename: string, caption?: string): Promise<unknown>;
    /**
     ...
     * @param caption
     */
    sendFileFromBase64(to: string, base64: string, filename: string, caption?: string): Promise<unknown>;
    /**
     ...
     * @param caption
     */
    sendFile(to: string, path: string, filename: string, caption?: string): Promise<unknown>;
    /**
     ...
     */
    sendImageAsStickerGif(to: string, path: string): Promise<unknown>;
    /**
     ...
     * @param to chatId '000000000000@c.us'
     */
    sendImageAsSticker(to: string, path: string): Promise<unknown>;
    /**
