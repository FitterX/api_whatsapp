    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (browser === 'connect') {
                        spinnies.fail(Session + "-auth", {
                            text: "Erro ao tentar conectar " + mergedOptions.browserWS,
                        });
                        browser = null;
                        throw "Erro ao tentar conectar " + mergedOptions.browserWS;
                    }
                    if (browser === 'launch') {
                        spinnies.fail(Session + "-auth", {
                        ...
                        browser = null;
                        throw "Erro ao abrir o navegador";
                    }
                    if (!(browser !== null)) return [3 /*break*/, 11];
                    spinnies.add("browser", {
                        text: 'verificar sem cabeçalho',
                    });
                    if (mergedOptions.headless) {
                        spinnies.succeed("browser", {
                            text: 'a opção cabeçalho está ativa, o navegador está oculto',
                        });
                    }
                    else {
                        spinnies.succeed("browser", {
                            text: 'opção cabeçalho está desabilitada, navegador visível',
                        });
                    }
                ...
                case 4:
                    _c.sent();
                    spinnies.succeed(Session + "-auth", { text: 'Autenticada' });
                    return [3 /*break*/, 7];
                case 5:
                    if (statusFind) {
                        statusFind('notLogged', Session);
                    }
                    spinnies.add("autoclose", { text: 'verificar fechar automático' });
                    if (mergedOptions.autoClose > 0) {
                        spinnies.succeed("autoclose", {
                            text: 'a função fechar automaticamente está ligada',
                        });
                        ////on autoclose
                        closeBrowser = setTimeout(function () {
                            ...
                            spinnies.fail(Session + "-auths", {
                                text: "Chamada de encerramento automático de sessão",
                            });
                            clearInterval(_fail);
                            clearInterval(browser_check);
                            clearTimeout(closeBrowser);
                        ...
                        spinnies.succeed("autoclose", {
                            text: 'a função de fechamento automático está desligada ',
                        });
                    }
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 4:
                                    ...
                                    if (catchQR) {
                                        catchQR(data, asciiQR, attempt++); //qrcode
                                    }
